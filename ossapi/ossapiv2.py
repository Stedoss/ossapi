...
class Ossapi:
    ...
    @request(Scope.PUBLIC, category="forums")
    def forum_listing(self) -> list[Forum]:
        """
        ...
        """
        return self._get(Forums, "/forums").forums

    @request(Scope.PUBLIC, category="forums")
    def forum_topics(self, forum_id: int) -> ForumTopics:
        """
        ...
        """
        return self._get(ForumTopics, f"/forums/{forum_id}")
